...
func (s server) CreateTodo(ctx context.Context, request *todos.CreateTodoRequest) (*todos.Todo, error) {
...
func (s server) GetTodo(ctx context.Context, request *todos.GetTodoRequest) (*todos.Todo, error) {
...
func (s server) GetList(ctx context.Context, request *todos.GetListRequest) (*todos.TodoList, error) {
